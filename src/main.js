...
import { FileAction, FileType, Permission as Permission32, registerFileAction as registerFileAction32 } from '@nextcloud/files-v3'
...
if (nextcloudVersionIsGreaterThanOr33) {
	...
	const baseAction = {
		...
		exec: async ({ nodes }) => {
			const file = nodes.filter((n) => n.type === 'file'
				&& typeof n.permissions === 'number')
